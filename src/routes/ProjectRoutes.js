...
// get 
router.get('/getProjectList', projectController.getProjectListFunction);
router.get('/getFlatList', projectController.getFlatListFunction);
router.get('/getEmployeeList', projectController.getEmployeeListFunction);
router.get('/getFlatStatusList', projectController.getFlatStatusFunction);
// post
router.post('/postProject', projectController.postProjectFunction);
...
// // delete 
// router.delete('/deleteProject', projectController.deleteProjectFunction);
// router.delete('/deleteFlat', projectController.deleteFlatFunction);
// router.delete('/deleteEmployee', projectController.deleteEmployeeFunction);
