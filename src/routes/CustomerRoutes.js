...
router.get('/getVisitList', customerController.getVisitListFunction);
router.get('/getSalesList', customerController.getSalesListFunction);
//post
...
router.put('/putCustomer', customerController.putCustomerFunction);
// delete 
